...
public class NeoSeedsExtendStage2 extends ItemSeeds
{
	 private Block field_150925_a, blockup;
	 private Block soilBlockID;
  public  NeoSeedsExtendStage2(Block down, Block up, Block p_i45352_2_)
  {
  ...
  public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_, int p_77648_5_, int p_77648_6_, int p_77648_7_, float p_77648_8_, float p_77648_9_, float p_77648_10_)
  {
	   ...
	   if(stage.getIdStage() == 0) {  p_77648_2_.addChatMessage(new ChatComponentTranslation("neo.DENY_PLANTAMOD"));p_77648_2_.addChatMessage(new ChatComponentTranslation("neo.DENY_PLANTA2MOD")); return false;}
      if (p_77648_7_ != 1)
      {
          return false;
      }
