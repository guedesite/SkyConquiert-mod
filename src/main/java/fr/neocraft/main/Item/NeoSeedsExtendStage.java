...
public class NeoSeedsExtendStage extends ItemSeeds
{
	 private Block field_150925_a;
	 private Block soilBlockID;
   public NeoSeedsExtendStage(Block p_i45352_1_, Block p_i45352_2_)
   {
   ...
   public boolean onItemUse(ItemStack p_77648_1_, EntityPlayer p_77648_2_, World p_77648_3_, int p_77648_4_, int p_77648_5_, int p_77648_6_, int p_77648_7_, float p_77648_8_, float p_77648_9_, float p_77648_10_)
   {
   	...
   	Stage stage = RegisterStage.getStageAtXY(p_77648_3_.getChunkFromBlockCoords(p_77648_4_, p_77648_6_).xPosition, p_77648_3_.getChunkFromBlockCoords(p_77648_4_, p_77648_6_).zPosition, p_77648_3_);
   	if(stage == null) { return false;}
   	if(stage.getIdStage() == 0) { return false;}
       if (p_77648_7_ != 1)
       {
           return false;
       }
       ...
       {
           if (canSustainPlant(p_77648_3_.getBlock(p_77648_4_, p_77648_5_, p_77648_6_), p_77648_3_, p_77648_4_, p_77648_5_, p_77648_6_, ForgeDirection.UP, this) && p_77648_3_.isAirBlock(p_77648_4_, p_77648_5_ + 1, p_77648_6_))
           {
