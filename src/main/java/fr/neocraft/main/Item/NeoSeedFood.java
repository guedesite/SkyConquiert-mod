...
public class NeoSeedFood extends ItemFood implements IPlantable
{
    ...
    public NeoSeedFood(int p_i45351_1_, float p_i45351_2_, Block p_i45351_3_, Block p_i45351_4_)
    {
