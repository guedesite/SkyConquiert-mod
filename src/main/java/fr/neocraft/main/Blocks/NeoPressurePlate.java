...
public abstract class NeoPressurePlate extends Block
{


    private static final String __OBFID = "CL_00000194";

    protected NeoPressurePlate( Material p_i45387_2_)
    {
        super(p_i45387_2_);
    ...
    {
        this.blockIcon = p_149651_1_.registerIcon(neoreference.MOD_ID + ":barrier");
    }
}
