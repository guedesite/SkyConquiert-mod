...
public class BlockFarmLand extends Block
{
    ...
    {
        this.icon = p_149651_1_.registerIcon(neoreference.MOD_ID+":barrier");
    }
  ...
  @Override
    ...
    public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_)
    {
        ...
        if (!this.func_149821_m(p_149674_1_, p_149674_2_, p_149674_3_, p_149674_4_))
        {
            if (l > 0)
            {
                ...
                if(tile instanceof TileEntityFarmLand)
                {
                    ((TileEntityFarmLand)tile).setmeta(l - 1);
                }
            }
            else if (!this.func_149822_e(p_149674_1_, p_149674_2_, p_149674_3_, p_149674_4_))
            {
                ...
                this.dropBlockAsItem(p_149674_1_, p_149674_2_, p_149674_3_ + 1, p_149674_4_, new ItemStack(ItemMod.tuteur, 1, 0));
            }
        }
        else
        {
            ...
            if(tile instanceof TileEntityFarmLand)
            {
                ((TileEntityFarmLand)tile).setmeta(7);
            }
        }
    }
    ...
    public void onFallenUpon(World p_149746_1_, int p_149746_2_, int p_149746_3_, int p_149746_4_, Entity p_149746_5_, float p_149746_6_)
    {
        if (!p_149746_1_.isRemote && p_149746_1_.rand.nextFloat() < p_149746_6_ - 0.5F)
        {
           ...
           // this.dropBlockAsItem(p_149746_1_,p_149746_2_, p_149746_3_ + 1, p_149746_4_, new ItemStack(ItemMod.tuteur, 1, 0));
        }
    }
    ...
    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        if (material.isSolid())
        {
            ...
            this.dropBlockAsItem(p_149695_1_, p_149695_2_, p_149695_3_+1, p_149695_4_, new ItemStack(ItemMod.tuteur, 1, 0));
        }
    }
    ...
    {
    	this.dropBlockAsItem(w,x, y + 1, z, new ItemStack(ItemMod.tuteur, 1, 0));
    }
