...
public abstract class MobSpawnerBaseLogic
{
	...
	public void updateSpawner()
	{
	    if (this.isActivated())
	    {
	    	if(!this.truc)
	    	{
	    		Block temp = this.getSpawnerWorld()
	    				.getBlock(this.getSpawnerX()
	    						, this.getSpawnerY()
	    						, this.getSpawnerZ());
		    	truc = true;
	    	...
	    	if(this.truc)
	    	{
		        ...
		        else
		        {
		            ...
		            for (int i = 0; i < this.spawnCount; ++i)
		            {
						...
						try {
							Class classe = (Class) BlockMod.AllSpawner.get(this.entityTypeName);
			                // Récupération du constructeur prenant en paramètre une chaîne de caractères
			                java.lang.reflect.Constructor constructeur = 
			                               classe.getConstructor (new Class [] {World.class});
							entity = (Entity) constructeur.newInstance (new Object [] {this.getSpawnerWorld()});
	...
	{
	    this.entityTypeName = p_98270_1_.getInteger("EntityId");
	    this.truc = p_98270_1_.getBoolean("truc");
	...
	{
	    p_98280_1_.setInteger("EntityId", this.entityTypeName);
	    p_98280_1_.setBoolean("truc", this.truc);
