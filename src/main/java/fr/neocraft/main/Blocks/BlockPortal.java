...
public class BlockPortal extends BlockBreakable
{
    ...
    public BlockPortal(String txt, int id)
    {
       		...
       		if (p_149670_5_.ridingEntity == null && p_149670_5_.riddenByEntity == null)
               {
       			if(timeForPortal <= timeUntilPortal || timeUntilPortal == 0)
       			{
       				if(FMLCommonHandler.instance().getSide().equals(Side.CLIENT)){
						...
						out.writeUTF(this.getLocalizedName().replace("tile.Portail ", "").replace(".name", ""));
						C17PacketCustomPayload packet = new C17PacketCustomPayload("NeoPortailEnter", out.toByteArray());
