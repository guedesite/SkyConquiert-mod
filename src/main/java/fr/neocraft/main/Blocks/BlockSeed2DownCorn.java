...
public class BlockSeed2DownCorn extends BlockCrops{
	...
	private Item 
		Item1 = ItemMod.Corn_Seeds, 
		Item2 = ItemMod.Corn;
	private Block 
		blockup = BlockMod.Corn_Culture_Up;
	public BlockSeed2DownCorn() {
	...
	public void breakBlock(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_, int p_149749_6_)
    {
		...
		if(p_149749_1_.getBlockMetadata(p_149749_2_, p_149749_3_, p_149749_4_) == 7)
		{
			this.dropBlockAsItemWithChance(p_149749_1_, p_149749_2_,p_149749_3_,  p_149749_4_, p_149749_6_, 0F, 0);
		}
    }
	...
	private float func_149864_n(World p_149864_1_, int p_149864_2_, int p_149864_3_, int p_149864_4_)
    {
	 ...
	 @Override
	    public ArrayList<ItemStack> getDrops(World world, int x, int y, int z, int metadata, int fortune)
	    {
	        ...
	        if (metadata >= 7)
	        {
	        	ret.add(new ItemStack(ItemMod.Corn_Seeds, 1, 0));
	            ...
	            for (int i = 0; i < 3 + fortune; ++i)
	            {
	                ...
	                {
	                    ret.add(new ItemStack(ItemMod.Corn, 1, 0));
	                }
	            }
