...
public class MoneyOrb extends Entity
{
    /** A constantly increasing value that RenderXPOrb uses to control the colour shifting (Green / yellow) */
    public int MoneyColor;
    /** The age of the XP orb in ticks. */
    public int MoneyOrbAge;
    public int field_70532_c;
    /** The health of this XP orb. */
    private int MoneyOrbHealth = 5;
    /** This is how much XP this orb has. */
    public int MoneyValue;
    /** The closest EntityPlayer to this orb. */
    private EntityPlayer closestPlayer;
    /** Threshold color for tracking players */
    private int MoneyTargetColor;
    private static final String __OBFID = "CL_00001544";

    public MoneyOrb(World p_i1585_1_, double p_i1585_2_, double p_i1585_4_, double p_i1585_6_, int p_i1585_8_)
    {
        super(p_i1585_1_);
    ...
    public MoneyOrb(World p_i1586_1_)
    {
        super(p_i1586_1_);
    ...
    public void onUpdate()
    {
        ...
        if (this.MoneyTargetColor < this.MoneyColor - 20 + this.getEntityId() % 100)
        {
            ...
            this.MoneyTargetColor = this.MoneyColor;
        }
    ...
    public boolean attackEntityFrom(DamageSource p_70097_1_, float p_70097_2_)
    {
        ...
        else
        {
            ...
            this.MoneyOrbHealth = (int)((float)this.MoneyOrbHealth - p_70097_2_);

            if (this.MoneyOrbHealth <= 0)
            {
                this.setDead();
            }
    ...
    {
        p_70014_1_.setShort("Health", (short)((byte)this.MoneyOrbHealth));
        p_70014_1_.setShort("Age", (short)this.MoneyOrbAge);
        p_70014_1_.setShort("Value", (short)this.MoneyValue);
    }
    ...
    {
        this.MoneyOrbHealth = p_70037_1_.getShort("Health") & 255;
        this.MoneyOrbAge = p_70037_1_.getShort("Age");
        this.MoneyValue = p_70037_1_.getShort("Value");
    }
    ...
    public void onCollideWithPlayer(EntityPlayer p_70100_1_)
    {
        if (!this.worldObj.isRemote)
        {
            ...
            {
                PlayerStats.get(p_70100_1_).AddPlayerTakeOrbMoney(p_70100_1_, this.getXpValue());
                this.worldObj.playSoundAtEntity(p_70100_1_, "random.pop", 0.1F, 0.5F * ((this.rand.nextFloat() - this.rand.nextFloat()) * 0.7F + 1.8F));
                this.setDead();
            }
        }
    }
