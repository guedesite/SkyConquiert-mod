...
public class BoxVoteSlot extends Slot
{
    ...
    public BoxVoteSlot(IInventory p_i1824_1_, int p_i1824_2_, int p_i1824_3_, int p_i1824_4_)
    {
    ...
    public boolean isItemValid(ItemStack p_75214_1_)
    {
    	...
    	if(this.slotIndex == 0)
    	{
    		if(p_75214_1_.getItem() == ItemMod.Vote_Key)
    		{
    			return true;
    		}
    		else
    	...
    	else if(this.slotIndex == 1 || this.slotIndex == 2 || this.slotIndex == 3 || this.slotIndex == 4 || this.slotIndex == 5)
    	{
    		...
    		if(p_75214_1_.getDisplayName().contains(C.d_yellow+"["+C.l_yellow+"Box"+C.d_yellow+"]"+C.l_yellow))
    		{
    			return true;
    		}
    		else
    ...
    public boolean canTakeStack(EntityPlayer p_82869_1_)
    {
        	...
        	{
        		if(getStack().getItem() == ItemMod.Vote_Key)
        		{
        			return true;
        		}
        		else
