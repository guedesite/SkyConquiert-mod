...
public class BuilderTileEntity extends TileEntity implements IInventory
{
    ...
    public ItemStack getStackInSlot(int slotIndex)
    {
	 ...
	 @Override
	    ...
	    {
	        return this.hasCustomInventoryName() ? this.customName : "Builder";
	    }
	...
	public void closeInventory() {
	 ...
	 @Override
	  ...
	  public ItemStack[] GetDistantSlotInv()
	  {
		  return contents;
	  }
