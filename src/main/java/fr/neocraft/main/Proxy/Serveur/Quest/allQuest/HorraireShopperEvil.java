...
public class HorraireShopperEvil extends Quest implements Serializable{
	...
	public String Name = "";
	private int state = 0;
	private int idQuest = 1;
	public boolean Do = false;
	
	public HorraireShopperEvil() {
		
	}
	
	@Override
	public void Init(Side side) {
		Element[0] = new ElementQuest(getTextQuest(side,"neo.quest2.title"), getTextQuest(side,"neo.quest2.text"), "kill_evil", new ItemStack(ItemMod.bouclier), 30,-1, "", "");
	...
	public void End(EntityPlayer p) {
		Do = true;
		GetElement().RecompenseWithRandomDmg(p, 2);
	...
	public Quest copy() {
		// TODO Auto-generated method stub
		return new HorraireShopperEvil();
	}
}
