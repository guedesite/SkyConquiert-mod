...
public class HorraireKillWitch extends Quest implements Serializable{
	...
	public String Name = "";
	private int state = 0;
	private int idQuest = 6;
	
	public boolean Do = false;
	
	public HorraireKillWitch() {
		
	}
	
	@Override
	public void Init(Side side) {
		Element[0] = new ElementQuest(getTextQuest(side,"neo.quest6.title"), getTextQuest(side,"neo.quest7.text"), "kill_witch", new ItemStack(ItemMod.bouclier), 10,-1, "", "");
	...
	public void End(EntityPlayer p) {
		Do = true;
		GetElement().RecompenseWithRandomDmg(p, 4);
