...
public class HorraireKillEnderman extends Quest implements Serializable{
	...
	public String Name = "";
	private int state = 0;
	private int idQuest = 8;
	
	public boolean Do = false;
	
	public  HorraireKillEnderman(){ }
	
	@Override
	public void Init(Side side) {
		Element[0] = new ElementQuest(getTextQuest(side,"neo.quest6.title"), getTextQuest(side,"neo.quest6.text"), "kill_enderman", new ItemStack(ItemMod.NeoDium_Nuggets), 5,-1, "", "");
	...
	public void End(EntityPlayer p) {
		Do = true;
		GetElement().RecompenseWithRandomNb(p, 5);
	...
	public Quest copy() {
		...
		return new HorraireKillEnderman();
	}
}
