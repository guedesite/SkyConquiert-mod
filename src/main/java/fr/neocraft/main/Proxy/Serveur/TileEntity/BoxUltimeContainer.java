...
public class BoxUltimeContainer extends Container{

	private final BoxUltimeTileEntity NeoTile;
    ...
    public BoxUltimeContainer(BoxUltimeTileEntity tile, InventoryPlayer p_i1812_2_, World w, EntityPlayer p)
    {
        this.NeoTile = tile;
        ...
        tile.openInventory();
        this.addSlotToContainer(new BoxUltimeSlot(tile, 0, 80, 4));
        this.addSlotToContainer(new BoxUltimeSlot(tile, 1, 42, 36));
        this.addSlotToContainer(new BoxUltimeSlot(tile, 2, 60, 36));
        this.addSlotToContainer(new BoxUltimeSlot(tile, 3, 80, 36));
        this.addSlotToContainer(new BoxUltimeSlot(tile, 4, 100, 36));
        this.addSlotToContainer(new BoxUltimeSlot(tile, 5, 118, 36));
    ...
    public BoxUltimeTileEntity getTile()
    {
    	return NeoTile;
    }
