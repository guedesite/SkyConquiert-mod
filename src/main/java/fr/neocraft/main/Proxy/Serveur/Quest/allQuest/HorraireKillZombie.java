...
public class HorraireKillZombie extends Quest implements Serializable{
	...
	public String Name = "";
	private int state = 0;
	private int idQuest = 5;
	
	public boolean Do = false;
	
	public HorraireKillZombie() {
		
	}
	
	@Override
	public void Init(Side side) {
		Element[0] = new ElementQuest(getTextQuest(side,"neo.quest6.title"), getTextQuest(side,"neo.quest9.text"), "kill_zombie", new ItemStack(ItemMod.bouclier), 30,-1, "", "");
