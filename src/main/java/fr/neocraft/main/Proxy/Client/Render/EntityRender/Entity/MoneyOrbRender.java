...
public class MoneyOrbRender extends Render
{
    private static final ResourceLocation experienceOrbTextures = new ResourceLocation(neoreference.MOD_ID+":textures/entity/money_orb.png");
    private static final String __OBFID = "CL_00000993";

    public MoneyOrbRender()
    {
     ...
     */
    public void doRender(MoneyOrb p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
        GL11.glPushMatrix();
     ...
     */
    protected ResourceLocation getEntityTexture(MoneyOrb p_110775_1_)
    {
    ...
    {
        return this.getEntityTexture((MoneyOrb)p_110775_1_);
    }
    ...
    {
        this.doRender((MoneyOrb)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
    }
}
