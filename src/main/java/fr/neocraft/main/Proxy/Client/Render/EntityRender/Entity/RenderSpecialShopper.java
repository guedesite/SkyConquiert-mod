...
public class RenderSpecialShopper implements ISimpleBlockRenderingHandler
{
    @Override
    public void renderInventoryBlock(Block block, int metadata, int modelId, RenderBlocks renderer)
    {
        if(block == BlockMod.Shopper)
        {
            GL11.glPushMatrix();
            ...
            GL11.glTranslatef(0F, -1F, 0F);
             ...
             Minecraft.getMinecraft().getTextureManager().bindTexture(ShopperTileEntitySpecialRenderer.texture);
             ShopperTileEntitySpecialRenderer.model.render();
            GL11.glPopMatrix();
