...
public class GuiTuto extends GuiScreen
{
    ...
    private boolean isFirstQuest = false;
    
    
    public GuiTuto(String f, String title)
    {
    	if(title.equals(I18n.format("neo.info.titre.1")))
    	{
    		isFirstQuest = true;
    	}
    ...
    protected void actionPerformed(GuiButton B)
    {
    	if(isFirstQuest)
    	{
    		main.getNetWorkServer().sendToServer(new NetWorkServer(new ServerActionGuiCmd(0, -1)));
    	}
