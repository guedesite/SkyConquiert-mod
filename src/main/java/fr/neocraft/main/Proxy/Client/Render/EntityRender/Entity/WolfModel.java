...
public class WolfModel extends ModelBase{
    ...
    public WolfModel()
    {
        ...
        this.wolfHeadMain.addBox(-2.5F, -3.0F, -2.0F, 6, 6, 4, f);
        ...
        this.wolfTail.addBox(-0.5F, 0.0F, -1.0F, 2, 8, 2, f);
    ...
    public void render(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float p_78088_7_)
    {
        ...
        if (((EntityPet)p_78088_1_).IsChild())
        {
            float f6 = 2.0F;
            GL11.glPushMatrix();
    ...
    {
        EntityPet entitywolf = (EntityPet)p_78086_1_;
