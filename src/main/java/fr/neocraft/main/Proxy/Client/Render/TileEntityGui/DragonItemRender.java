...
public class DragonItemRender  extends RenderItem
{
     ...
     */
    public void renderItemIntoGUI(FontRenderer p_77015_1_, TextureManager p_77015_2_, ItemStack p_77015_3_, int p_77015_4_, int p_77015_5_, int id)
    {
        this.renderItemIntoGUI(p_77015_1_, p_77015_2_, p_77015_3_, p_77015_4_, p_77015_5_, false, id);
    }

    public void renderItemIntoGUI(FontRenderer p_77015_1_, TextureManager p_77015_2_, ItemStack p_77015_3_, int p_77015_4_, int p_77015_5_, boolean renderEffect, int id)
    {
        ...
        float f4;
            ...
            this.renderIcon(p_77015_4_, p_77015_5_, (IIcon)object, id, id);
          
            GL11.glEnable(GL11.GL_LIGHTING);
            GL11.glDisable(GL11.GL_ALPHA_TEST);
            GL11.glDisable(GL11.GL_BLEND);

            int effect = p_77015_3_.getTagCompound().getInteger("NeoEffect");
            if (effect != 0)
            {
                renderEffect(p_77015_2_, p_77015_4_, p_77015_5_, id, effect);
            }
            GL11.glEnable(GL11.GL_LIGHTING);
    ...
    public void renderItemAndEffectIntoGUI(FontRenderer p_82406_1_, TextureManager p_82406_2_, final ItemStack p_82406_3_, int p_82406_4_, int p_82406_5_, int id)
    {
        if (p_82406_3_ != null)
        {
            this.zLevel += 50.0F;
            ...
            try
            {
                ...
                {
                    this.renderItemIntoGUI(p_82406_1_, p_82406_2_, p_82406_3_, p_82406_4_, p_82406_5_, true, id);
                }
            }
    ...
    public void renderEffect(TextureManager manager, int x, int y, int id, int effect)
    {
        GL11.glDepthFunc(GL11.GL_EQUAL);
        GL11.glDisable(GL11.GL_LIGHTING);
        ...
        this.renderGlint(x * 431278612 + y * 32178161, x , y , id,id);
        GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
