...
public class NeoTextField extends Gui
{
    ...
    public NeoTextField(FontRenderer p_i1032_1_, int p_i1032_2_, int p_i1032_3_, int p_i1032_4_, int p_i1032_5_)
    {
                            ...
                            if (ChatAllowedCharacters.isAllowedCharacter(p_146201_1_))
                            {
                                if (this.isEnabled)
                                {
                                	...
                                	if(p == Keyboard.KEY_0 
                                			...
                                			||p == Keyboard.KEY_8 
                                			|| p == Keyboard.KEY_9 
                                			|| p == Keyboard.KEY_NUMPAD0
                                			|| p == Keyboard.KEY_NUMPAD1
                                			|| p == Keyboard.KEY_NUMPAD2
                                			|| p == Keyboard.KEY_NUMPAD3
                                			|| p == Keyboard.KEY_NUMPAD4
                                			|| p == Keyboard.KEY_NUMPAD5
                                			|| p == Keyboard.KEY_NUMPAD6
                                			|| p == Keyboard.KEY_NUMPAD7
                                			|| p == Keyboard.KEY_NUMPAD8
                                			|| p == Keyboard.KEY_NUMPAD9)
                                	{
                                		if(p == Keyboard.KEY_0 ) {
