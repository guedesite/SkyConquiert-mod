...
public class GolemModel extends ModelBase{
	  ...
	  public ModelRenderer ironGolemHead;
	    ...
	    public GolemModel(float p_i1161_1_)
	    {
	        this(p_i1161_1_, -7.0F);
	    }
	    
 public GolemModel(float p_i1162_1_, float p_i1162_2_)
 {
     short short1 = 128;
     short short2 = 128;
     this.ironGolemHead = (new ModelRenderer(this)).setTextureSize(short1, short2);
     this.ironGolemHead.setRotationPoint(0.0F, -7.0F, 0F);
     this.ironGolemHead.setTextureOffset(0, 0).addBox(-4.0F, 3.5F, -5.5F, 8, 10, 8, p_i1162_1_); //tete
     this.ironGolemHead.setTextureOffset(24, 0).addBox(-1.0F, 10.5F, -7.5F, 2, 4, 2, p_i1162_1_); // nez
 ...
 public void render(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float p_78088_7_)
 {
         ...
         float f6 = 2.0F;
         GL11.glPushMatrix();
         GL11.glTranslatef(0.0F,p_78088_7_+0.11F, 2.0F * p_78088_7_-0.1F);
