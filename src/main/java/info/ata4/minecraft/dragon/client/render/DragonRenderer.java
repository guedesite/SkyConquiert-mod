...
public class DragonRenderer extends RenderLiving {
    ...
    private final ResourceLocation dissolveTexture = new ResourceLocation(neoreference.MOD_ID, TEX_BASE + "dissolve.png");
    private final ResourceLocation eggTexture = new ResourceLocation(neoreference.MOD_ID, MDL_BASE + "dragon_egg.obj");
