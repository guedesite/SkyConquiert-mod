...
public class DragonModel extends ModelBase {
    ...
    public DragonModel(DragonBreed breed) {
        ...
        bodyTexture = new ResourceLocation(neoreference.MOD_ID, DragonRenderer.TEX_BASE + breed.getSkin() + "/body.png");
        glowTexture = new ResourceLocation(neoreference.MOD_ID, DragonRenderer.TEX_BASE + breed.getSkin() + "/glow.png");
        saddleTexture = new ResourceLocation(neoreference.MOD_ID, DragonRenderer.TEX_BASE + breed.getSkin() + "/saddle.png");
        eggTexture = new ResourceLocation(neoreference.MOD_ID, DragonRenderer.TEX_BASE + breed.getSkin() + "/egg.png");
